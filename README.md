...
### 4. 27/11/2020- I fixed the links of all the html pages to go to the educational materials page and updated the functionality to sign out by only displaying the option when the user is signed in. I also fixed the functionality createMaterialLink() to now have the link to the copyright license for the material on the license name.I fixed and merged the code(ViewBookings page along with its javascript file and tests) taken from my teammates' versions of the app and also applied the changes made to the home page. The changes applied also included updates to the Bookings page and its javascript file. I ran the tests cases for the app and created a test for signout(). I also changed the tests cases for the register page javascript to remove unnecessary code. I ran all tests and as all passed, I uploaded the app as version-0.4.4 to Github. I noticed we had not used the news page for covid updates but differed it's functionality to the home page instead.(3hrs)
